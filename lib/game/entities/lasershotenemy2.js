...
EntityLasershotenemy2 = EntityProjectile.extend({
	...
	animSheet: new ig.AnimationSheet( 'media/lasershotenemy2.png', 3, 5 ),
...
ig.EntityPool.enableFor( EntityLasershotenemy2 );

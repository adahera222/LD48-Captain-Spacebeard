ig.module(
	'game.entities.smallenemy2'
)
.requires(
	'impact.entity',
	'game.entities.lasershotenemy2'
	
)
.defines(function(){

EntitySmallenemy2 = ig.Entity.extend({
	...
	animSheet: new ig.AnimationSheet( 'media/smallenemy2.png', 30, 30 ),
	
	sfxHurt: new ig.Sound( 'media/sounds/enemy_hurt.*' ),
	sfxExplode: new ig.Sound( 'media/sounds/explosion.*'),
	firingSound: new ig.Sound('media/sounds/enemy_shoot.*'),
	...
	init: function( x, y, settings ) {
		...
		this.addAnim( 'explode', 0.11, [3,4,5,6,7], true)
	},
	...
	fire: function() {
		ig.game.spawnEntity( EntityLasershotenemy2, this.pos.x+10, this.pos.y+24 );
		ig.game.spawnEntity( EntityLasershotenemy2, this.pos.x+14, this.pos.y+24 );
